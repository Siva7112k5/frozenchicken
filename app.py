...
# Add this at the bottom of app.py (after all routes, before if __name__ == '__main__')
...
def init_db():
    ...
    with app.app_context():
        ...
        if Product.query.count() == 0:
            ...
            sample_products = [
                Product(name='Frozen Whole Chicken (Farm Fresh)', 
                       description='Whole chicken, farm-frozen at peak freshness.', 
                       price_per_kg=280, 
                       category='Whole Chicken',
                       image_file='whole-chicken.jpg',
                       stock_status='In Stock',
                       thawing_instructions='Refrigerator: 24 hours',
                       nutritional_info='Protein 25g, Fat 8g per 100g',
                       is_bestseller=True),
                
                Product(name='Premium Frozen Chicken Breast', 
                       description='Boneless, skinless chicken breast.', 
                       price_per_kg=450, 
                       category='Chicken',
                       image_file='chicken-breast.jpg',
                       stock_status='In Stock',
                       thawing_instructions='Refrigerator: 12 hours',
                       nutritional_info='Protein 31g, Fat 3.6g per 100g',
                       is_bestseller=True),
            ]
...
if __name__ == '__main__':
    init_db()  # This creates tables and adds sample data
    app.run(debug=True)